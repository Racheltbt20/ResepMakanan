...
<section class="hero-area">
  <div class="hero-slides owl-carousel">
    ...
    <div class="single-hero-slide bg-img" style="background-image: url('{{ Storage::url($latest_recipe->galleries()->first()->path) }}')">
        ...
        <div class="row h-100 align-items-center">
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
              ...
              <a href="{{ route('recipe.show', $latest_recipe->slug) }}" class="btn mt-5 delicious-btn" data-animation="fadeInUp" data-delay="1000ms">See Receipe</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="single-best-receipe-area mb-30">
          <img src="{{ Storage::url($recipe->galleries()->first()->path) }}" alt="" />
    ...
    <div class="row h-100 align-items-center">
      <div class="col-12">
        ...
        <div class="cta-content text-center">
          ...
          <a href="{{ route('recipe') }}" class="btn delicious-btn">Discover all the receipies</a>
        </div>
      </div>
    </div>
  </div>
